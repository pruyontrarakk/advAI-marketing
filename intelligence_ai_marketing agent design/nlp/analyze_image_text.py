...
# Paths
PROJECT = "/content/drive/MyDrive/Colab Notebooks/intelligence_ai_marketing"
INPUT_CSV = "/content/drive/MyDrive/Colab Notebooks/intelligence_ai_marketing/data/collected_ads_enriched.csv"
OUTPUT_CSV = f"{PROJECT}/data/image_text_analysis.csv"
